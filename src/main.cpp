...
int servo1_switch_count = 0;
int servo2_switch_count = 0;
int servo_switch_count = 0;

int servo1_increment = 1;
int servo2_increment = 1;

int servo_target_1 = 180;
int servo_target_2 = 0;

int servo1_step = 0;
int servo2_step = 0;
int servo1_target = servo_target_1;
int servo2_target = servo_target_1;
...
void loop() {
  ...
  // if(servo1_target == servo_target_1 && servo1_step < servo1_target && servo1_switch_count > SERVO_SWITCH_THRESHOLD){

  //   servo1_step += servo1_increment;
  //   servo_1.control.write(servo1_step);
  //   servo1_switch_count = 0;

  // }
  
  // else if(servo1_target == servo_target_2 && servo1_step > servo1_target && servo1_switch_count > SERVO_SWITCH_THRESHOLD){
  ...
  // }
  // if(servo1_switch_count > SERVO_SLEEP_THRESHOLD){
  ...
  // if(servo1_target == servo_target_2 && servo1_step > servo1_target && servo1_switch_count > SERVO_SWITCH_THRESHOLD){
